...
const Navbar = () => {
  ...
  return (
    <nav className=" px-6 md:px-12 py-5 flex items-center justify-between relative">
      <a href="#" style={{ fontFamily: 'sans-serif'}} className="text-3xl text-white font-semibold"> 
         Rise at Seven
      </a>
      <div
        className={`
        ...
        <img
          src={Close_icon}
          alt="close"
          className="w-6 absolute top-5 right-5 sm:hidden cursor-pointer bg-white rounded"
          onClick={() => setSidebar(false)}
        />
        {menuItems.map((item, index) => (
          <div key={index} className="relative group py-3">
            <a
              href="#"
              onClick={() => setSidebar(false)}
            ...
            <div className="absolute left-0 top-full pt-4 hidden group-hover:flex bg-[#EFEEEC] rounded-[30px] shadow-lg p-8 w-[900px] justify-between z-50 max-sm:hidden">
